...
public class ReportBController implements Initializable {
    ...
    private void reportB(ActionEvent actionEvent) {
        ...
        try {//Intenta la conexion con la base de datos
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbBank", "root", "Egualos123");//Realizando la conexion a la base de datos
